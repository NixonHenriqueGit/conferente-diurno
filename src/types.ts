...
export interface AuditSession {
  ...
  surplusActionStatus?: 'prazo_envio_ok' | 'fora_do_prazo' | 'enviado_cliente'; // for Sobras
  deficitActionStatus?: 'pendente_baixa' | 'baixado'; // for Faltas
  ...
  surplusFlowStatus?: 'PENDENTE' | 'ENCAMINHADO' | 'ENVIADO'; // Status do fluxo de sobras
